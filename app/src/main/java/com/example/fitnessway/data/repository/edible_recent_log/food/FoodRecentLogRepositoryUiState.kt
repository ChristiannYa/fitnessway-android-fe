...
data class FoodRecentLogRepositoryUiState(
    override val uiStatePager: UiStatePager<FoodPreview> = UiStatePager()
) : RepositoryPagerState<FoodPreview, FoodRecentLogRepositoryUiState> {

    override fun copyWithPager(pager: UiStatePager<FoodPreview>): FoodRecentLogRepositoryUiState =
